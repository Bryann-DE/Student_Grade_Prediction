The aim of this project is to explore the student test scores data set obtained from kaggle and visalize the trends and effect of each of the features on the overall test score for each student.
